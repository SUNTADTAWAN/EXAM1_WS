...
#ifndef TURTLE_INTERFACES__SRV__DETAIL__PIZZA__FUNCTIONS_H_
#define TURTLE_INTERFACES__SRV__DETAIL__PIZZA__FUNCTIONS_H_
...
/// Create srv/Pizza message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * turtle_interfaces__srv__Pizza_Request__init().
...
/// Destroy srv/Pizza message.
/**
 * It calls
 * turtle_interfaces__srv__Pizza_Request__fini()
...
/// Check for srv/Pizza message equality.
/**
...
/// Initialize array of srv/Pizza messages.
/**
...
/// Finalize array of srv/Pizza messages.
/**
 * It calls
 * turtle_interfaces__srv__Pizza_Request__fini()
...
/// Create array of srv/Pizza messages.
/**
 * It allocates the memory for the array and calls
 * turtle_interfaces__srv__Pizza_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Pizza messages.
/**
 * It calls
 * turtle_interfaces__srv__Pizza_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Pizza message array equality.
/**
...
/// Copy an array of srv/Pizza messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * turtle_interfaces__srv__Pizza_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_turtle_interfaces
...
/**
 * It calls
 * turtle_interfaces__srv__Pizza_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_turtle_interfaces
...
/**
 * It allocates the memory for the array and calls
 * turtle_interfaces__srv__Pizza_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_turtle_interfaces
...
/**
 * It calls
 * turtle_interfaces__srv__Pizza_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TURTLE_INTERFACES__SRV__DETAIL__PIZZA__FUNCTIONS_H_
