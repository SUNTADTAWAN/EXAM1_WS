...
static const _Pizza_Request_type_support_symbol_names_t _Pizza_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_interfaces, srv, Pizza_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtle_interfaces, srv, Pizza_Request)),
  }
};
...
{
  return &::turtle_interfaces::srv::rosidl_typesupport_cpp::Pizza_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtle_interfaces, srv, Pizza_Request)() {
  return get_message_type_support_handle<turtle_interfaces::srv::Pizza_Request>();
}
...
static const _Pizza_Response_type_support_symbol_names_t _Pizza_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_interfaces, srv, Pizza_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtle_interfaces, srv, Pizza_Response)),
  }
};
...
{
  return &::turtle_interfaces::srv::rosidl_typesupport_cpp::Pizza_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtle_interfaces, srv, Pizza_Response)() {
  return get_message_type_support_handle<turtle_interfaces::srv::Pizza_Response>();
}
...
static const _Pizza_type_support_symbol_names_t _Pizza_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_interfaces, srv, Pizza)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtle_interfaces, srv, Pizza)),
  }
};
...
{
  return &::turtle_interfaces::srv::rosidl_typesupport_cpp::Pizza_service_type_support_handle;
}
