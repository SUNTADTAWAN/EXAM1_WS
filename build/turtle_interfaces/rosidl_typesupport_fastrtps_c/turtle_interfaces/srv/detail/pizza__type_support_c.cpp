...
#include "turtle_interfaces/srv/detail/pizza__rosidl_typesupport_fastrtps_c.h"
...
size_t get_serialized_size_turtle_interfaces__srv__Pizza_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Pizza_Request__ros_msg_type * ros_message = static_cast<const _Pizza_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Pizza_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_turtle_interfaces__srv__Pizza_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtle_interfaces
size_t max_serialized_size_turtle_interfaces__srv__Pizza_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Pizza_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtle_interfaces__srv__Pizza_Request(
...
static message_type_support_callbacks_t __callbacks_Pizza_Request = {
...
static rosidl_message_type_support_t _Pizza_Request__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Pizza_Request,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_interfaces, srv, Pizza_Request)() {
  return &_Pizza_Request__type_support;
}
...
using _Pizza_Response__ros_msg_type = turtle_interfaces__srv__Pizza_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Pizza_Response__ros_msg_type * ros_message = static_cast<const _Pizza_Response__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _Pizza_Response__ros_msg_type * ros_message = static_cast<_Pizza_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: structure_needs_at_least_one_member
  {
    cdr >> ros_message->structure_needs_at_least_one_member;
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtle_interfaces
size_t get_serialized_size_turtle_interfaces__srv__Pizza_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Pizza_Response__ros_msg_type * ros_message = static_cast<const _Pizza_Response__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Pizza_Response__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_turtle_interfaces__srv__Pizza_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtle_interfaces
size_t max_serialized_size_turtle_interfaces__srv__Pizza_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtle_interfaces__srv__Pizza_Response;
    is_plain =
      (
...
static size_t _Pizza_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtle_interfaces__srv__Pizza_Response(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_Pizza_Response = {
  "turtle_interfaces::srv",
  "Pizza_Response",
...
static rosidl_message_type_support_t _Pizza_Response__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Pizza_Response,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_interfaces, srv, Pizza_Response)() {
  return &_Pizza_Response__type_support;
}
...
// already included above
// #include "turtle_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "turtle_interfaces/srv/pizza.h"
...
static service_type_support_callbacks_t Pizza__callbacks = {
  "turtle_interfaces::srv",
  "Pizza",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_interfaces, srv, Pizza_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_interfaces, srv, Pizza_Response)(),
...
static rosidl_service_type_support_t Pizza__handle = {
  rosidl_typesupport_fastrtps_c__identifier,
  &Pizza__callbacks,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_interfaces, srv, Pizza)() {
  return &Pizza__handle;
}
